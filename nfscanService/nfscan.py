...
class Processor(Iface, TProcessor):
  ...
  def process_predict(self, seqid, iprot, oprot):
    ...
    result = predict_result()
    try:
      result.success = self._handler.predict(args.info_string)
...
class predict_args:
  ...
  thrift_spec = (
    None, # 0
    (1, TType.STRING, 'info_string', None, None, ), # 1
  )
    ...
    while True:
      ...
      if fid == 1:
        if ftype == TType.STRING:
          self.info_string = iprot.readString()
        else:
          iprot.skip(ftype)
      else:
        iprot.skip(ftype)
  ...
  def write(self, oprot):
    ...
    if self.info_string is not None:
      oprot.writeFieldBegin('info_string', TType.STRING, 1)
      oprot.writeString(self.info_string)
      oprot.writeFieldEnd()
  ...
  def __hash__(self):
    value = 17
    value = (value * 31) ^ hash(self.info_string)
    return value
